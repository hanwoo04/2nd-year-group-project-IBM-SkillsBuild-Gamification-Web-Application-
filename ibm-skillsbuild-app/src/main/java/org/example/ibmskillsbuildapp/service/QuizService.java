...
public class QuizService {
    ...
    private static List<Question> createHardcodedQuestions() {
        ...
        questions.add(new Question(1, "Which framework is used for building enterprise applications in Java?",
                "Spring Framework", "ReactJS", "Vue.js", 1)); // Option A is correct
        questions.add(new Question(2, "IBM Watson SDK for Java is used to integrate with what type of IBM services",
                "1989", "Artificial intelligence services", "2000", 2)); // Option B is correct
        questions.add(new Question(3, "What is the principle of writing reusable code components in Java?",
                "Cloud storage", "Artificial intelligence services", "Blockchain services", 3)); // Option C is correct
        questions.add(new Question(4, "Which tool is preferred for continuous integration/continuous delivery (CI/CD) in Java projects, often used in IBM tutorials?",
